...
Create a professional resume for the following person. Output ONLY valid JSON, no markdown, no explanation.
...
Rules:
- Use strong action verbs (Built, Developed, Optimized, Led, Reduced, Improved)
- Quantify achievements with numbers wherever possible
- Include keywords relevant to {target_role}
- Keep summary under 3 sentences
- Make bullets achievement-focused, not duty-focused
"""
